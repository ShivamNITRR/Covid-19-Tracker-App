...
public class EachCountryDataActivity extends AppCompatActivity {
    ...
    private void GetIntent() {
            ...
            str_countryName = intent.getStringExtra(Constants.COUNTRY_NAME);
            str_confirmed = intent.getStringExtra(Constants.COUNTRY_CONFIRMED);
            str_active = intent.getStringExtra(Constants.COUNTRY_ACTIVE);
            str_death = intent.getStringExtra(Constants.COUNTRY_DECEASED);
            str_recovered = intent.getStringExtra(Constants.COUNTRY_RECOVERED);
            str_confirmed_new = intent.getStringExtra(Constants.COUNTRY_NEW_CONFIRMED);
            str_death_new = intent.getStringExtra(Constants.COUNTRY_NEW_DECEASED);
            str_tests = intent.getStringExtra(Constants.COUNTRY_TESTS);
        }
    @Override
