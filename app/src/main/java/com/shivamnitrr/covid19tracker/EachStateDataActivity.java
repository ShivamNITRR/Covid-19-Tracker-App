...
public class EachStateDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lin_district.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constants.STATE_NAME, str_stateName);
    ...
    private void GetIntent() {
        ...
        str_stateName = intent.getStringExtra(Constants.STATE_NAME);
        str_confirmed = intent.getStringExtra(Constants.STATE_CONFIRMED);
        str_confirmed_new = intent.getStringExtra(Constants.STATE_CONFIRMED_NEW);
        str_active = intent.getStringExtra(Constants.STATE_ACTIVE);
        str_death = intent.getStringExtra(Constants.STATE_DEATH);
        str_death_new = intent.getStringExtra(Constants.STATE_DEATH_NEW);
        str_recovered = intent.getStringExtra(Constants.STATE_RECOVERED);
        str_recovered_new = intent.getStringExtra(Constants.STATE_RECOVERED_NEW);
        str_lastupdatedate = intent.getStringExtra(Constants.STATE_LAST_UPDATE);
    }
}